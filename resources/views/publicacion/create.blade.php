...
<div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="titulo" id="titulo" class="form-control" placeholder="Ingrese el titulo" maxlength="45">
        </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="cuerpo" id="cuerpo" class="form-control" placeholder="Ingrese un cuerpo" maxlength="45">
        </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    <div class="form-group">
